...
function CounterApp() {
   ...
   const togglefunctionalit= () =>{
    ...
    return (
      <div className="App">
          <CardComponent heading="Counter function Component" Subheadings="Counter function component" 
          description="This is Counter function Card Component" togglefun={togglefunctionalit}/>
          {toggle?
          <>
